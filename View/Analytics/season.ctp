...
?>
		...
		<?php
			...
			if(isset(${$seasonCountsName})){
				$victoryCount = ${$seasonCountsName}["victoryCount"];
				$allCount = ${$seasonCountsName}["allCount"];
				$normalCount = ${$seasonCountsName}["normalCount"];
				$wetCount = ${$seasonCountsName}["wetCount"];
